...
app.gamebar = { _strategicMessageActive: true, proposalAudience: null };
assert.equal(canSnapshotState(app), false);
app.gamebar._strategicMessageActive = false;
app.gamebar.proposalAudience = { type: "domestic-budget" };
assert.equal(canSnapshotState(app), false);
app.gamebar.proposalAudience = null;
